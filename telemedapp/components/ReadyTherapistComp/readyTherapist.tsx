        ...
        <section>
            <div className='bg-white rounded-3xl p-4 flex flex-col space-y-8 max-w-full md:max-w-[90%] lg:max-w-[75%] mx-auto'>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex items-center text-xs md:text-xl'><GoDotFill className='rounded-full bg-lime-600 max-w-1 max-h-1 p-1 mr-4' />3 Doctor are ready to start now within 15 mins</div>
